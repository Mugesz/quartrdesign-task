      ...
      <div className="row">
        <div className="col-lg-6 d-lg-flex align-items-center">
          <p className="text-center aboutme-para">
            I am a <span className="product-designer">Product Designer</span>{" "}
            ...
            <span className="product-designer">Design Thinking</span>{" "}
        ...
        <div className="col-lg-6 d-lg-flex align-items-center">
          <p className="text-center aboutme-para align-lg-second">
            ...
            <span className="product-designer">technology</span> trends. That
            way, I bring an updated opinion of the Tech industry.
          </p>
        </div>
        <div className="col-lg-6 d-lg-flex align-items-center">
          <p className="text-center aboutme-para">
            ...
            <span className="lomb">lomb</span>
            <span className="ian">ian</span> and in me you will find a human
